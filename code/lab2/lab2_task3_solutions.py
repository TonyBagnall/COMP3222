...
import numpy as np
"""
Lab 2 Task 3: Inside DecisionTreeClassifier

this just has some explOratory code to visualise decision trees trained on
the Italy Power Demand dataset from aeon.
